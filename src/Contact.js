    ...
    render() {
        return (
            <div style={styles.background}>
                ...
                <p className="wow fadeIn" data-wow-duration="3s" data-wow-delay=".5s" data-wow-offset="20" style={styles.title}><b>I'm currently looking for a position where I'll be working with websites.  Drop me a line if you would like to chat.</b></p>
