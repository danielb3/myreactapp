    ...
    render() {
        return (
            <div style={styles.background}>
                ...
                <br/>
                <p className="wow fadeIn" data-wow-duration="3s" data-wow-delay=".5s" data-wow-offset="20" style={styles.par}>I got started in web development by taking a coding boot camp just because I wanted to just know more about web development.  During the program I found coding to be enjoyable and decided to focus more of my attention towards pursuing it more in-depth.  Since finishing the boot camp in the summer of 2018, I have used my skills to build my own websites and apps as well as study PHP, Python, Perl, C, C#, .NET, WordPress, and Java (though I prefer working with JavaScript).  And I'm still continuing to learn and improve each day.</p>
                <p className="wow fadeIn" data-wow-duration="3s" data-wow-delay=".5s" data-wow-offset="20" style={styles.par}>In learning and diagnosing errors I encounter, I use a variety of sites like Stack Overflow, w3schools, Google, Medium, and YouTube.</p>
                <p className="wow fadeIn" data-wow-duration="3s" data-wow-delay=".5s" data-wow-offset="20" style={styles.par}>Most of my work is a combination of code I find online that I then edit to fit in with my project.  I pay attention to the way my apps look and feel as well as functionality.  I like when both form and function intersect and improve upon each other.</p>
