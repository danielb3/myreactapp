    ...
    render() {
        return (
            <div style={styles.background}>
                ...
                <p className="wow fadeIn" data-wow-duration="1s" data-wow-delay=".5s" data-wow-offset="20" style={styles.par}>Most of my work is a combination of code I find online that I then edit to fit in with my project.  I like to see other's people final projects and if I like a feature or design of theirs, I will try to emulate it on my own.</p>
                ...
                <p className="wow fadeIn" data-wow-duration="1s" data-wow-delay=".5s" data-wow-offset="20" style={styles.par}>In 1-2 years, I hope to be working on part of a team developing websites/web applications.  In 7-10 years I would like to be a product lead, developing a really cool web app or software program.<br/><br/></p>
            </div>
        )}
}
